...
#include "../include/libHCSR04_ros/UltrasonicHCSR04Wrapper.hpp"
...
UltrasonicHCSR04Wrapper::UltrasonicHCSR04Wrapper() : Node("HCSR04_ultrasonic_driver")
{
    ...
    this->declare_parameter<std::string>("relative_to_frame_id", "base_link");
    ...
    reference_frame_ = this->get_parameter("relative_to_frame_id").as_string();
